...
const SelectField: React.FC<SelectFieldProps> = ({
  ...
  return (
    <View className="mb-4">
      ...
      {isOpen && (
        <View className="mt-2 rounded-lg border border-gray-200 bg-white  dark:border-neutral-700 dark:bg-neutral-800">
  ...
  return (
    <View className="flex-1 bg-gray-50 dark:bg-neutral-900">
      ...
      <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
        {/* 基本信息 */}
        <View className="mb-4 rounded-2xl bg-white p-5 dark:bg-neutral-800">
        ...
        <View className="flex-row">
          <View className="mr-3 flex-1">
            <Button
              ...
              className="my-0 h-12 rounded-lg"
