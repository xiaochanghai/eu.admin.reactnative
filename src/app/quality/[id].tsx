              ...
              <View>
                ...
                <View className="border-b border-gray-200 dark:border-gray-700">
                  <View className="flex-row">
                    <Text className="w-24 px-2 py-3 text-sm text-gray-900 dark:text-gray-100">
                      电路连通性
                    </Text>
                    <Text className="w-20 px-2 py-3 text-sm text-gray-900 dark:text-gray-100">
                      100%
                    </Text>
                    <Text className="w-20 px-2 py-3 text-sm text-gray-900 dark:text-gray-100">
                      99.5%
            ...
            <View className="mb-4 flex-row items-center">
              ...
              <View className="w-2/3 pl-4">
                ...
                <View className="mb-1 flex-row items-center">
                  ...
                  <Text className="mr-2 text-xs text-gray-600 dark:text-gray-400">
                    焊接不良
                  </Text>
